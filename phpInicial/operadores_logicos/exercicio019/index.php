    ...
    <div class="row">
        ...
        <form action="index.php" method="post">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="numero1" name="numero1" placeholder="Digite o primeiro Numero">
                </div>

                <div class="mb-3">
                    <label for="numero2" class="form-label">Numero 2 : </label>
                    <input type="number" class="form-control" id="numero2" name="numero2" placeholder="Digite o segundo Numero">
                </div>
            ...
            <h2 class="text-center">
                ...
                if($numero1 == $numero2){
                    echo "Os numeros são iguais : $numero1 e $numero2";

                }else{
                    echo "Os numeros são diferentes : $numero1 e $numero2 sendo o maior : ";
                    if($numero1 > $numero2){
                        echo $numero1; 
                    }else{
                        echo $numero2;
